      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-[1.15fr,1fr] gap-12 lg:gap-14 items-center">
          ...
          <div>
            {/* Badge */}
            <div
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-gold/40 bg-gold/[0.06] backdrop-blur text-sm font-medium text-white/90 mb-8 animate-fade-in-up"
            ...
            {/* Headline */}
            <h1
              className="font-black text-[2.75rem] sm:text-6xl lg:text-[5rem] leading-[0.92] tracking-[-0.035em] mb-6 animate-fade-in-up"
            ...
            {/* Sub */}
            <p
              className="text-base sm:text-lg text-white/60 max-w-xl mb-10 leading-relaxed animate-fade-in-up"
            ...
            <a
              href="#contact"
              className="group inline-flex items-center gap-2 px-7 py-4 rounded-full bg-gold text-black font-black uppercase text-sm tracking-wider hover:bg-gold-bright hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 shadow-[0_0_50px_rgba(255,210,48,0.45)] mb-12 animate-fade-in-up"
            ...
            {/* Stats cards */}
            <div
              className="grid grid-cols-3 gap-3 sm:gap-4 max-w-2xl animate-fade-in-up"
              style={{ animationDelay: "420ms" }}
            >
              {stats.map((s, i) => (
                <div
                  key={s.label}
                  className="rounded-2xl border border-white/[0.08] bg-white/[0.02] backdrop-blur px-4 sm:px-5 py-4 sm:py-5 hover:border-gold/30 hover:bg-white/[0.04] hover:-translate-y-0.5 transition-all duration-500 animate-fade-in-up"
          ...
          <div
            className="relative h-[560px] lg:h-[640px] overflow-hidden animate-fade-in-up"
